...
function sans_scripts() {
	if ( true === WP_DEBUG ) {
		...
		wp_enqueue_script( 'sans-main', get_template_directory_uri() . '/assets/js/main.js', array(), '3.0.2', true );
		...
		wp_enqueue_script( 'sans-main', get_template_directory_uri() . '/assets/js/main.min.js', array(), '3.0.2', true );
